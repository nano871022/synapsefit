...
class RecordWorkoutSessionUseCaseTest {
    ...
    @Test
    fun `when exerciseId is empty, return failure`() =
        runTest {
    ...
    @Test
    fun `when repsCompleted is zero or negative, return failure`() =
        runTest {
    ...
    @Test
    fun `when weightLiftedKg is negative, return failure`() =
        runTest {
    ...
    @Test
    fun `when parameters valid, save log and return log`() =
        runTest {
